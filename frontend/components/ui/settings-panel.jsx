...
const SettingsPanel = ({ isOpen, onClose, settingsCategory, setSettingsCategory }) => {
  ...
  return (
   <div className="fixed inset-0 backdrop-blur-[0.5px] backdrop-brightness-95 flex items-center justify-center z-50 p-4">
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    <div className="grid grid-cols-2 gap-4">
                      ...
                      <div className="border-2 border-gray-300 rounded-xl p-4 flex flex-col items-center cursor-pointer">
                        <div className="flex items-center gap-2 mb-2">
                          <MoonIcon className="w-5 h-5" />
                          <span>Dark</span>
                        </div>
